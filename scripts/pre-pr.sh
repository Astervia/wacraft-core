...
#
# Actions vs checks:
#   gofmt      → AUTO-FIXES with gofmt -w (not just a lint check)
...
launch gofmt bash -c '
    files="$(gofmt -l .)"
    if [ -n "$files" ]; then
        echo "Auto-formatted the following files:"
        printf "  %s\n" $files
        gofmt -w .
    else
...
# Memory mode: no external dependencies required.
...
# ─────────────────────────────────────────────────────────────────────────────
# Gate: wait for lint + test checks before proceeding to govulncheck.
...
# ─────────────────────────────────────────────────────────────────────────────
# Drain any still-running wave-1 checks (gitleaks)
# ─────────────────────────────────────────────────────────────────────────────
